...
ZombieChar:          var #1
EmptyChar:           var #1
store PlayerChar, #'A'           ; Caractere do jogador
store ShotChar, #'*'             ; Caractere do tiro
store ZombieChar, #'Z'           ; Caractere do zumbi
store EmptyChar, #32             ; Espaço vazio

ScreenWidth:         var #1
ScreenHeight:        var #1
ShotCooldownTime:    var #1
ZombieMoveTime:      var #1
store ScreenWidth, #40           ; Largura da tela
store ScreenHeight, #30          ; Altura da tela
store ShotCooldownTime, #200     ; Delay de tiro (0.2s em ms)
store ZombieMoveTime, #500       ; Movimento zumbis (0.5s em ms)
...
ZombieTimer:         var #1
GameOverFlag:        var #1
store PlayerPos, #0                ; Posição atual do jogador
store LastKey, #0                  ; Última tecla pressionada
store ShotActive, #0               ; 0=Inativo, 1=Ativo
store ShotPos, #0                  ; Posição do tiro
store ShotDirection, #0            ; Direção do tiro (0-3)
store ShotTimer, #0                ; Timer para movimento do tiro
store ZombieTimer, #0              ; Timer para movimento zumbis
store GameOverFlag, #0             ; 0=Jogo ativo, 1=Game Over
...
ZombieCount:         var #1
store ZombieCount, #3 ; Número de zumbis ativos
...
initialize_game:
    ...
    store ZombiesPos+1, r0
    loadn r0, #800          ; Zumbi 3
    store ZombiesPos+2, r0
    
    loadn r0, #1            ; Estado vivo
    store ZombiesAlive, r0
    store ZombiesAlive+1, r0
    store ZombiesAlive+2, r0
    ...
    loadn r0, #ZombiesPos+1
    loadi r0, r0
    outchar r1, r0
    
    loadn r0, #ZombiesPos+2
    loadi r0, r0
    outchar r1, r0
